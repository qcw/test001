...
cmd="
 /home/pai/bin/python -m torch.distributed.launch --nproc_per_node=2 run_tasks.py --model ${model} --task ${task}
    ...
    --weight_decay 0.01  --num_layers ${layers}  --chk_path ${chkpath}  --max_seq_len 4096 --batch_size 16 --learning_rate 1e-4
...
runexp   1    text  attention_SKT      "LRA_chks/text_dynamic_v77_softmax_d_sigmoid_n_1_1015"    2       64    -1      8     1e-4  0.01 1234
