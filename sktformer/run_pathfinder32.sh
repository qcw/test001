...
/home/pai/bin/python -m torch.distributed.launch --nproc_per_node=4 run_tasks.py --model ${model} --task ${task}
    ...
    --dropout_prob 0.1 --attention_dropout 0.1 --learning_rate 1e-4 --rnn_dropout 0.5
...
runexp    0   pathfinder32-curv_contour_length_14  attention_SKT    "LRA_chks/path_dynamic_v77_softmax_d_softmax_n_1_1017"    2   32    -1      8     1e-2   0.0 1234 
