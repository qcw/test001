...
cmd="
 python -m torch.distributed.launch --nproc_per_node=8 run_tasks.py --model ${model} --task ${task}
    ...
    --dropout_prob 0.5 --attention_dropout 0.5 --rnn_dropout 0.5
    --num_train_steps 120000 --num_eval_steps 320 --eval_frequency 175 --batch_size 32 --learning_rate 1e-3 --warmup 175 --dp_rank 32
...
runexp   0     image  attention_SKT    "LRA_chks/image_dynamic_v77_softmax_d_softmax_n_.1.9_warmup=175_r=256_1015"    2     16    -1      8     1e-4 0.0 1234
